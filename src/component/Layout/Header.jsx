...
const products = [
  {
    name: "View",
    description: "Get a better understanding of Product",
    link: "/product",
    icon: EyeIcon,
  },
  {
    name: "Edit",
    description:
      "Change the description, Edit the attributes as well as add new ones",
    link: "/product/edit",
    icon: PencilIcon,
  },
];
      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-9 w-auto" src={config?.logo} alt="" />
          </a>
        </div>
